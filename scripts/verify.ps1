...
Write-Host "- Pencil VS Code extension installed if you use .pen files"
Write-Host "- Pencil OS skills copied from codex-template/skills to your Codex skills folder"
